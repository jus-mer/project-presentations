...
# Market Justice and deserving of Social Welfare {style="font-size:21px; text-align:right; line-height:1.1;"}

### **Presentation of the proyect** {style="font-size:35px; text-align:right; line-height:1.1; margin-top:12px;"}
...
:::{.notes}
Here are the descriptive results **and** as the figure shows, people perceive that privilege takes precedence over effort and talent in the distribution of rewards in society.
...
**but** even though they are few, we **mast not** downplay their importance.
:::
...
After that, we performed a confirmatory factor analysis to assess the model's validity

**and** If we look at the factor loadings, the four factors provide a good explanation of their corresponding items.

Furthermore, the CFI, TLI and RMSEA indicate the model is valid in terms of its latent structure.
:::
...
:::{.notes}
Along the same lines, another project we are currently working on involves the **reliability** of the multidimensional meritocracy framework among the school population.

We are able to evaluate this because, in a previous research project, we conducted a survey in schools that included the meritocracy scale.

**So**, as we can see in the figure, the factor loadings can be considered good from a statistical standpoint,

 as can the fit indices, with the RMSEA falling close to the cutoff
:::

##

:::{.notes}
However, everything we have seen so far has involved the use of the meritocracy scale **but** with variable-centered methods.

So, I have sought to move toward the use of person-centered methods to observe **how** meritocratic beliefs—such as the perception of effort—are organized in people’s minds
...
Let’s imagine that meritocratic beliefs are the brown ones and beliefs about privilege are the red ones

We already know that people can believe in both, but what we don’t know is how these different types of beliefs are organized. 

So, to find that out, I plan to use Latent Class Analysis, a person-centered method that allows us to observe the heterogeneity of beliefs in the population by classifying subgroups

By “heterogeneity,” I also mean differences in beliefs regarding the number of groups that can be identified and the degree to which each group is represented in the population
...
I’d like to conclude by mentioning that this research on latent classes is part of my master’s thesis, and the next steps are to study the relationship between these classes and market justice in education, 

I plan to finish—or at least have a first draft of—the thesis by the end of this year, and to complete it during the first semester of next year, as I will be on a research fellowship with the “Students’ Perception of Inequality and Fairness (PerFair)” project at the University of Konstanz.
:::
