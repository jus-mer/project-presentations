...
### **FONDECYT Grant 2025-2029** {style="font-size:35px; text-align:right; line-height:1.1; margin-top:12px;"}
...
August 2026 - University of Chile 
...
## Changes in market justice preferences

![](https://www.frontiersin.org/api/ipx/w=716&f=webp/https://www.frontiersin.org/files/Articles/1634219/xml-images/fsoc-10-1634219-g0002.webp){fig-align="center"}
...
- **So far**: the extant literature focuses on political institutions as drivers of redistributive preferences (policy feedback in welfare regimes)
...
- **We need**: 
  - Development of measurement instruments (valid estimands)
  - Instead of discovering "paradoxes", better theoretical background - as for instance Mau et al.(2024) Triggerpunkte
  - Including larger variation in contextual inequality in comparative research
