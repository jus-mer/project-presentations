...
We then applied the model proposed by our team, and the results were as follows:
:::
...
:::{.notes}
If we look at the factor loadings, the four factors provide a good explanation of their corresponding items.

 Furthermore, the fit indices indicate that the model is valid in terms of its latent structure.
:::
...
:::{.notes}
So, with this in mind, we applied the multidimensional model of meritocracy in a survey, and as the figure shows, people perceive that privilege takes precedence over effort and talent in the distribution of rewards in society.

But when we ask people **what** they prefer, the picture is reversed. The vast majority would like effort to be the guiding principle for success, while talent takes a back seat. In contrast, only a minority believes it is acceptable for family wealth or connections to influence society’s rewards, but even though they are few, we **mast not** downplay their importance.
:::
...
:::{.notes}
Another project we are currently working on involves verifying the reliability of the multidimensional meritocracy framework among the school population. As we can see in the figure, the factor loadings can be considered good from a statistical standpoint, as can the fit indices, with the RMSEA falling close to the cutoff

However, everything we have seen so far has involved the use of the meritocracy scale but with variable-centered methods. With this in mind, we have sought to move toward the use of person-centered methods to observe how meritocratic beliefs—such as the perception of effort—are organized in people’s minds
:::
...
To do this, we use latent class analysis, a statistical method that allows us to identify different types of groups based on the probability that they will give similar responses. In this way, we can also test hypotheses regarding the number and size of the groups that exist in society.
...
:::{style="font-size: 18px;"}
- [Class 3 Universal rewards]{style="color: #1e358a;"} (20.7%): This profile reflects a belief system in which merit and privilege operate simultaneously. They strongly support meritocracy, though they hold an ambivalent stance toward privilege: they view it as less legitimate than other groups do, but they **do not reject it entirely**
...
:::{style="font-size: 24px;"}
  - [Class 4 Against privilege]{style="color: #78c99a; font-size: 28px;"} (6.8%): This group exhibits an **attitude against privilege factors** as they do not perceive privilege, nor do they want it to exist in society.
:::
